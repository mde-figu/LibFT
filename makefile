...
#    Updated: 2021/02/11 13:33:35 by mde-figu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES = ft_isprint.c ft_memset.c ft_strjoin.c ft_strtrim.c ft_atoi.c
 ...
 ft_isalpha.c ft_lstdelone.c ft_memcmp.c ft_split.c ft_strncmp.c ft_isascii.c
 ft_memcpy.c ft_strchr.c ft_strnstr.c ft_isdigit.c ft_lstlast.c 
